...
‣ Numero del Dueño wa.me/+573142753447
...
┃Ex : ${prefix}Ephoto 25 vendo pan_
┠⊷️ *${prefix}Textpro list*
┃   Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃Ex : ${prefix}Textpro 55 vendo leche_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
exec(`ffmpeg -i ${anum} ${ran}`, (err) => {
  fs.unlinkSync(anum)
  if (err) return reply('me saturaron el bot :v no mentiras pero miren que el video sea de menos de 10 segundos mas o menos')
...
//--google voice
				case 'tts':
					...
					ranm = getRandom('.mp3')
					dtt.length > 600
					? reply('aprenda a escribir mejor xD no mentiras cambie el texto por algun formato  mas normal ')
...
mentions('〘  *a* 〙\n-\n┠⊷'+teks+'۝֎𝙺𝚒𝚗𝚐|𝙱𝚘𝚝_𝚟𝟹֎۝, members_id, true)
break
...
//--menaikan jabatan
      case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Ahora @${mentioned[0].split('@')[0]} es admin del grupo tenes el power absoluto!`, mentioned, true)
...
tm = `listo mijin ya sos legal use  ${prefix}Menu para ver la lista`
reply(tm)
break
...
break
  ...
  reply(`        ────────────────\nHola *${pushname}* !!!\npase copia en ves de estar poniendo comandos que ni existen : *${prefix}${command}*\nponga esto mejor*${prefix}Menu*\n        ────────────────`)
				}
